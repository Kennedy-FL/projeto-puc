...
O projeto busca integrar tecnologia e responsabilidade ambiental, fornecendo uma ferramenta acessível e intuitiva para a sociedade.

Objetivos principais

Criar uma aplicação web simples e responsiva.

Disponibilizar informações sobre pontos de coleta de recicláveis.

Incentivar práticas sustentáveis no dia a dia.

Exercitar conceitos de HTML, CSS e JavaScript.
